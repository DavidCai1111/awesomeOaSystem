!function (c) {
    ...
    d.prototype = {
        constructor: d, setColor: function (f) {
            f = f.toLowerCase();
            var e = this;
            ...
            m += [g, e, e, g, 0, 0][j];
            f += [0, 0, g, e, e, g][j];
            return {r: Math.round(i * 255), g: Math.round(m * 255), b: Math.round(f * 255), a: l || this.value.a}
            ...
            return {h: j, s: i, l: e, a: g || this.value.a}
        }
    };
    var a = function (f, e) {
        this.element = c(f);
    ...
    a.prototype = {
        constructor: a, show: function (f) {
        ...
        }, pointer: null, slider: null, mousedown: function (h) {
            h.stopPropagation();
            h.preventDefault();
            var g = c(h.target);
            var f = g.closest("div");
            if (!f.is(".colorpicker")) {
                ...
                this.pointer = {left: h.pageX, top: h.pageY};
                c(document).on({
            ...
            f.stopPropagation();
            f.preventDefault();
            c(document).off({mousemove: this.mousemove, mouseup: this.mouseup});
            return false
        }
    };
    c.fn.colorpicker = function (e, f) {
        return this.each(function () {
            var i = c(this), h = i.data("colorpicker"), g = typeof e === "object" && e;
            if (!h) {
                i.data("colorpicker", (h = new a(this, c.extend({}, c.fn.colorpicker.defaults, g))))
            }
            if (typeof e === "string") {
                h[e](f)
            }
