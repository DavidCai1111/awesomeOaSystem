!function ($) {
    ...
    Markdown.prototype = {
        constructor: Markdown, __alterButtons: function (name, alter) {
            ...
            for (i = 0; i < buttonsArray.length; i++) {
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    for (z = 0; z < buttons.length; z++) {
                        var button = buttons[z], buttonToggle = "", buttonHandler = ns + "-" + button.name, btnText = button.btnText ? button.btnText : "", btnClass = button.btnClass ? button.btnClass : "btn", tabIndex = button.tabIndex ? button.tabIndex : "-1";
                        if (button.toggle == true) {
                            buttonToggle = ' data-toggle="button"'
                        }
                        btnGroupContainer.append('<button class="' + btnClass + ' btn-default btn-sm" title="' + button.title + '" tabindex="' + tabIndex + '" data-provider="' + ns + '" data-handler="' + buttonHandler + '"' + buttonToggle + '><span class="' + button.icon + '"></span> ' + btnText + "</button>");
            ...
            if (this.$editor == null) {
                ...
                if (options.savable) {
                    var editorFooter = $("<div/>", {"class": "md-footer"}), saveHandler = "cmdSave";
                    handler.push(saveHandler);
                    callback.push(options.onSave);
                    editorFooter.append('<button class="btn btn-success" data-provider="' + ns + '" data-handler="' + saveHandler + '"><i class="fa fa-check"></i> Save</button>');
            ...
            var options = this.$options, callbackContent = options.onPreview(this), container = this.$textarea, afterContainer = container.next(), replacementContainer = $("<div/>", {
                "class": "md-preview",
            ...
            if (typeof start == "string") {
                ...
                if (typeof start == "numeric" && typeof end == "numeric") {
    ...
    $.fn.markdown.defaults = {
        ...
        buttons: [[{
            name: "groupFont",
            data: [{
                name: "cmdBold", title: "Bold", icon: "glyphicon glyphicon-bold", callback: function (e) {
                ...
                name: "cmdItalic", title: "Italic", icon: "glyphicon glyphicon-italic", callback: function (e) {
                    var chunk, cursor, selected = e.getSelection(), content = e.getContent();
                    if (selected.length == 0) {
                ...
                name: "cmdHeading", title: "Heading", icon: "glyphicon glyphicon-font", callback: function (e) {
                    ...
                    if ((pointer = 4, content.substr(selected.start - pointer, pointer) == "### ") || (pointer = 3, content.substr(selected.start - pointer, pointer) == "###")) {
                        ...
                        if (prevChar = content.substr(selected.start - 1, 1), !!prevChar && prevChar != "\n") {
                            e.replaceSelection("\n\n### " + chunk + "\n");
            ...
            name: "groupLink",
            data: [{
                name: "cmdUrl", title: "URL/Link", icon: "glyphicon glyphicon-globe", callback: function (e) {
                ...
                name: "cmdImage", title: "Image", icon: "glyphicon glyphicon-picture", callback: function (e) {
                    var chunk, cursor, selected = e.getSelection(), content = e.getContent(), link;
                    if (selected.length == 0) {
