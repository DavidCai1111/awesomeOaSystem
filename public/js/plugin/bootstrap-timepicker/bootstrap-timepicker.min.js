(function ($, window, document, undefined) {
    ...
    Timepicker.prototype = {
        constructor: Timepicker, _init: function () {
            var self = this;
            ...
            if (this.orientation.x !== "auto") {
                ...
                if (offset.left < 0) {
                    ...
                    if (offset.left + widgetWidth > windowWidth) {
