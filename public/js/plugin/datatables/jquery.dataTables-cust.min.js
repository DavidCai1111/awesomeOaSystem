    ...
    (function (factory) {
        ...
        var DataTable = function (oInit) {
            ...
            function _fnFeatureHtmlFilter(oSettings) {
                ...
                sSearchStr = (sSearchStr.indexOf("_INPUT_") !== -1) ? sSearchStr.replace("_INPUT_", '<input class="form-control"  placeholder="Filter" type="text">') : sSearchStr === "" ? '<input type="text" />' : sSearchStr + ' <input type="text" />';
