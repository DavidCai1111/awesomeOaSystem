(function (c) {
    ...
    function d(v) {
        var h = null, A = null, m = null, s = null, n = null, f = false, u = null;
        var i = [];
        ...
        function z(G) {
            var E = 0, D = 0, I = 0, B = b.series.pie.combine.color, H = [];
        ...
        function o(G, J) {
            ...
            var C = G.getPlaceholder().width(), E = G.getPlaceholder().height(), I = A.children().filter(".legend").children().width() || 0;
            u = J;
            f = false;
        ...
        function l(B, H) {
            ...
            var I = {pageX: H.pageX, pageY: H.pageY};
            A.trigger(B, [I, J])
        }
    ...
    var b = {
        series: {
            pie: {
                ...
                label: {
                    show: "auto", formatter: function (f, g) {
