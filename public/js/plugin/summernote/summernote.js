...
(function ($) {
    ...
    var EventHandler = function () {
        ...
        var makeLayoutInfo = function (descendant) {
            ...
            return {
                ...
                codeable: function () {
                    return welEditor.find('.note-codeable');
                },
                statusbar: function () {
    ...
    var Renderer = function () {
        var aToolbarItem = {
            ...
            table: '<button type="button" class="btn btn-default dropdown-toggle" title="Table" data-toggle="dropdown" tabindex="-1"><i class="fa fa-table"></i> <span class="caret"></span></button>' +
            ...
            '</ul>',
            style: '<button type="button" class="btn btn-default dropdown-toggle" title="Style" data-toggle="dropdown" tabindex="-1"><i class="fa fa-magic"></i> <span class="caret"></span></button>' +
            '<ul class="dropdown-menu">' +
            ...
            '</ul>',
            fontsize: '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" title="Font Size" tabindex="-1"><span class="note-current-fontsize">11</span> <b class="caret"></b></button>' +
            '<ul class="dropdown-menu">' +
            ...
            '</ul>',
            color: '<button type="button" class="btn btn-default note-recent-color" title="Recent Color" data-event="color" data-value=\'{"backColor":"yellow"}\' tabindex="-1"><i class="fa fa-font" style="color:black;background-color:yellow;"></i></button>' +
            ...
            paragraph: '<button type="button" class="btn btn-default dropdown-toggle" title="Paragraph" data-toggle="dropdown" tabindex="-1"><i class="fa fa-align-left"></i>  <span class="caret"></span></button>' +
            '<ul class="dropdown-menu">' +
            '<li>' +
            ...
            '</li>' +
            '</ul>',
            height: '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" title="Line Height" tabindex="-1"><i class="fa fa-text-height"></i>&nbsp; <b class="caret"></b></button>' +
            '<ul class="dropdown-menu">' +
            ...
            fullscreen: '<button type="button" class="btn btn-default" title="Full Screen" data-event="fullscreen" tabindex="-1"><i class="fa fa-fullscreen"></i></button>',
