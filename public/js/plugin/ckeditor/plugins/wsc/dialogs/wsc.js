...
(function () {
    ...
    var o = function (a) {
        ...
        iframeOnload: function () {
            ...
            for (var b = b.grammSuggest, c = b.length, d = !0, f = 0; f < c; f++)a.grammerSuggest.getElement().append(y(b[f],
                b[f], d)), d = !1;
            l();
            a.div_overlay.setDisable()
        ...
        return {
            ...
            onShow: function () {
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    CKEDITOR.scriptLoader.load(b.config.wsc_customLoaderScript || c + "//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin=fck2&customerid=" + a.wsc_customerId + "&cmd=script&doc=wsc&schema=22", function (c) {
                        CKEDITOR.config && CKEDITOR.config.wsc && CKEDITOR.config.wsc.DefaultParams ? (a.serverLocationHash =
            ...
            contents: [{
                ...
                elements: [{type: "html", id: "banner", label: "banner", style: "", html: "<div></div>"}, {
                    type: "html", id: "Content", label: "spellContent",
                    html: "", setup: function (b) {
