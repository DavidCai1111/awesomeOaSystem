            ...
            title: a.lang.div.title, minWidth: 400, minHeight: 165, contents: [{
                ...
                if ("editdiv" == k)m = [this._element]; else {
                    var d = [], c = {}, h = [], b, i = a.getSelection(),
                        e = i.getRanges(), l = i.createBookmarks(), g, j;
                    ...
                    e = [];
                    g = null;
                    for (j = 0; j < h.length; j++)b = h[j], f = a.elementPath(b).blockLimit, a.config.div_wrapTable && f.is(["td", "th"]) && (f = a.elementPath(f.getParent()).blockLimit), f.equals(g) || (g = f, e.push([])),
                        e[e.length - 1].push(b);
