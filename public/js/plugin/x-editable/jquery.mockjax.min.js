...
(function (e) {
        ...
        var s = function (t) {
            return function () {
                return function () {
                    ...
                    if (r.dataType == "json" && typeof n.responseText == "object")this.responseText = JSON.stringify(n.responseText); else if (r.dataType == "xml")if (typeof n.responseXML == "string") {
                        this.responseXML = o(n.responseXML);
                        this.responseText = n.responseXML
                    } else this.responseXML = n.responseXML; else this.responseText = n.responseText;
    ...
    function h(t, n, r, i) {
        ...
        return {
            status: t.status, statusText: t.statusText, readyState: 1, open: function () {
            }, send: function () {
                i.fired = !0;
                c.call(this, t, n, r)
            }, abort: function () {
    ...
    function p(e, t, n) {
        ...
        if (e.data && i.test(e.data) || i.test(e.url)) {
            m(e, t, n);
            var r = /^(\w+:)?\/\/([^\/?#]+)/, s = r.exec(e.url), o = s && (s[1] && s[1] !== location.protocol || s[2] !== location.host);
            e.dataType = "script";
    ...
    function d(e) {
        if (e.type.toUpperCase() === "GET")i.test(e.url) || (e.url += (/\?/.test(e.url) ? "&" : "?") + (e.jsonp || "callback") + "=?"); else if (!e.data || !i.test(e.data))e.data = (e.data ? e.data + "&" : "") + (e.jsonp || "callback") + "=?"
    }
    ...
    function m(e, t, n) {
        var r = n && n.context || e, o = e.jsonpCallback || "jsonp" + s++;
    ...
    var t = e.ajax, n = [], r = [], i = /=\?(&|$)/, s = (new Date).getTime();
    e.extend({ajax: b});
    e.mockjaxSettings = {
        log: function (t, n) {
