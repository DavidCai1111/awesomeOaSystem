(function ($) {
    $.extend(true, window, {Slick: {AutoTooltips: AutoTooltips}});
    function AutoTooltips(options) {
        var _grid;
        var _self = this;
        var _defaults = {enableForCells: true, enableForHeaderCells: false, maxToolTipLength: null};
        ...
        $.extend(this, {init: init, destroy: destroy});
    }
})(jQuery);
(function ($) {
    $.extend(true, window, {Slick: {CellCopyManager: CellCopyManager}});
...
(function ($) {
    $.extend(true, window, {Slick: {CellRangeDecorator: CellRangeDecorator}});
    function CellRangeDecorator(grid, options) {
        var _elem;
        var _defaults = {
            selectionCssClass: "slick-range-decorator",
            selectionCss: {zIndex: "9999", border: "2px dashed red"}
        };
        options = $.extend(true, {}, _defaults, options);
        function show(range) {
            if (!_elem) {
        ...
        $.extend(this, {show: show, hide: hide});
    }
})(jQuery);
(function ($) {
    $.extend(true, window, {Slick: {CellRangeSelector: CellRangeSelector}});
    function CellRangeSelector(options) {
        ...
        var _defaults = {selectionCss: {border: "2px dashed blue"}};
        ...
        function handleDragEnd(e, dd) {
            ...
            e.stopImmediatePropagation();
            _decorator.hide();
            _self.onCellRangeSelected.notify({range: new Slick.Range(dd.range.start.row, dd.range.start.cell, dd.range.end.row, dd.range.end.cell)});
        }
...
(function ($) {
    $.extend(true, window, {Slick: {CellSelectionModel: CellSelectionModel}});
    function CellSelectionModel(options) {
        var _grid;
        var _canvas;
        var _ranges = [];
        var _self = this;
        var _selector = new Slick.CellRangeSelector({selectionCss: {border: "2px solid black"}});
        var _options;
...
(function ($) {
    $.extend(true, window, {Slick: {CheckboxSelectColumn: CheckboxSelectColumn}});
    function CheckboxSelectColumn(options) {
        var _grid;
        var _self = this;
        var _handler = new Slick.EventHandler();
        var _selectedRowsLookup = {};
        var _defaults = {columnId: "_checkbox_selector", cssClass: null, toolTip: "Select/Deselect All", width: 30};
...
(function ($) {
    $.extend(true, window, {Slick: {Plugins: {HeaderButtons: HeaderButtons}}});
    function HeaderButtons(options) {
        var _grid;
        var _self = this;
        var _handler = new Slick.EventHandler();
        var _defaults = {buttonCssClass: "slick-header-button"};
        ...
        function handleButtonClick(e) {
            ...
            if (command != null) {
                _self.onCommand.notify({grid: _grid, column: columnDef, command: command, button: button}, e, _self);
        ...
        $.extend(this, {init: init, destroy: destroy, onCommand: new Slick.Event()});
    }
})(jQuery);
(function ($) {
    $.extend(true, window, {Slick: {Plugins: {HeaderMenu: HeaderMenu}}});
    function HeaderMenu(options) {
        var _grid;
        var _self = this;
        var _handler = new Slick.EventHandler();
        var _defaults = {buttonCssClass: null, buttonImage: null};
        var $menu;
        ...
        function showMenu(e) {
            ...
            if (_self.onBeforeMenuShow.notify({grid: _grid, column: columnDef, menu: menu}, e, _self) == false) {
                return;
            }
            if (!$menu) {
        ...
        function handleMenuItemClick(e) {
            ...
            if (command != null && command != "") {
                _self.onCommand.notify({grid: _grid, column: columnDef, command: command, item: item}, e, _self);
            }
            e.preventDefault();
            e.stopPropagation();
        }
...
(function ($) {
    $.extend(true, window, {Slick: {RowMoveManager: RowMoveManager}});
    function RowMoveManager(options) {
        ...
        var _self = this;
        var _handler = new Slick.EventHandler();
        var _defaults = {cancelEditOnDrag: false};
        ...
        function handleDrag(e, dd) {
            ...
            if (insertBefore !== dd.insertBefore) {
                var eventData = {rows: dd.selectedRows, insertBefore: insertBefore};
        ...
        function handleDragEnd(e, dd) {
            ...
            if (dd.canMove) {
                var eventData = {rows: dd.selectedRows, insertBefore: dd.insertBefore};
...
(function ($) {
    $.extend(true, window, {Slick: {RowSelectionModel: RowSelectionModel}});
