...
$(document).ready(function () {
    ...
    $('#logout a').click(function (e) {
        ...
        // ask verification
        $.SmartMessageBox({
            title: "<i class='fa fa-sign-out txt-color-orangeDark'></i>  <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> 是否确认登出?",
            content: $.logoutMSG || "点击确定登出系统回到登陆页面",
            buttons: '[No][Yes]'
